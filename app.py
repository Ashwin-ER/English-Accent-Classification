            ...
            with col1:
                ...
                **Confidence Score:** {result['confidence']}%
                ...
                if result['second_best']:
                    st.markdown(f"""
                    **Secondary accent influence:** {result['second_best']} English
                    """)
            
            with col2:
                st.subheader("Detailed Scores")
                # Create accent score comparison chart
                ...
                chart_data = {"Accent": accents, "Score": normalized}
